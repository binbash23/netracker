...
DB_CREATE_SCRIPT_FILENAME="create_table_netevent.sql"
...
while read -a line_array; do 
  sqlcommand="insert into netevent (UUID, COLLECTION_UUID, INTERFACE, STATUS, IPV4) values ('`uuidgen`', '${COLLECTION_UUID}', '${line_array[0]}', '${line_array[1]}','${line_array[2]}')"
